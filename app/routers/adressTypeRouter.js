...
adressTypeRouter.put('/updateOne/:id', bodyMaker, validate(adressTypeChanged, 'body'), CW(controller.updateOne));
adressTypeRouter.delete('/deleteOne/:id', CW(controller.unactiveOne));
